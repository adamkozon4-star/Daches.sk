              ...
              >
                ...
                >
                  <Image
                    ...
                    sizes={
                      item.wide
                        ? "(min-width: 1240px) 778px, (min-width: 1024px) calc(66vw - 48px), 100vw"
                        : "(min-width: 1240px) 381px, (min-width: 1024px) calc(33vw - 32px), (min-width: 640px) calc(50vw - 40px), 100vw"
                    }
                    quality={80}
